...
export const sorterPrices = (currency: string, index: string) => {
  return (a: TCryptoData, b: TCryptoData): number => {
    if (a.pricesByCurrencies[currency] && !b.pricesByCurrencies[currency]) { return -1 } else if (b.pricesByCurrencies[currency] && !a.pricesByCurrencies[currency]) { return 1 } else if (!b.pricesByCurrencies[currency] && !a.pricesByCurrencies[currency]) { return 0 } else if (
